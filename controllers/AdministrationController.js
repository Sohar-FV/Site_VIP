...
module.exports.AjouterPhoto = function(request, response){
    ...
    // else {
        ...
        if (idVip) {
            ...
            model.ajoutPhoto(idVip, sujetPhoto, comPhoto, photo, function(err, result) {  // appel le module test qui exécute la requete SQL
                if (err) {
                    console.log(err);
                    return;
                }

                response.msg = "La photo a été ajouté !";
 ...
 module.exports.SupprimerPhoto = function(request, response){
    ...
    // else {
        ...
        if (vipId) {
            ...
            if (photoId) {
                model.deletePhoto(vipId, photoId, function(err, result) {  // appel le module test qui exécute la requete SQL
                    if (err) {
                        console.log(err);
                        return;
                    }
                ...
                model.photos(vipId, function(err, result) {  // appel le module test qui exécute la requete SQL
                    if (err) {
                        console.log(err);
                        return;
                    }
